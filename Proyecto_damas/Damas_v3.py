...
TIEMPO_POR_MOVIMIENTO = 30  # segundos que tiene cada jugador para elegir ficha
...
def input_con_tiempo(mensaje, segundos):
    # Pide un input() pero solo espera "segundos". Si no contestan a tiempo,
    # devuelve None en vez de quedarse esperando para siempre.
    respuesta = [None]
...
def jugar():
    ...
    while True:
        ...
        # Empieza una partida nueva y se reinicia el historial
        historial = []
        numero_movimiento = 1
        inicializar_tablero()
        turno = 'c'
        ...
        while True:
            ...
            mensaje = f"Tienes {TIEMPO_POR_MOVIMIENTO}s. Elige la ficha (ej: c2), escribe 'historial' o 'salir': "
            texto = input_con_tiempo(mensaje, TIEMPO_POR_MOVIMIENTO)
